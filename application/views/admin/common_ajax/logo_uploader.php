...
function afterSuccess()
{
	...
	else
	{
		...
		$('#admin_logo', parent.document).attr('src',obj.fileurl)
...
<h3>Change Logo</h3>
<h5>For best view : height :<strong>90px</strong> , width: <strong>225px</strong> </h5>
<form action="<?php echo ci_site_url('admin/ajax/logo_upload/')?>" method="post" enctype="multipart/form-data" id="MyUploadForm">
<div class="row">
	<div class="col-md-12">
...
<div class="row">
	<div class="col-md-12">
		<input type="submit"  id="submit-btn" value="Upload Logo" class="btn btn-primary btn-sm" />
    </div>
</div>
