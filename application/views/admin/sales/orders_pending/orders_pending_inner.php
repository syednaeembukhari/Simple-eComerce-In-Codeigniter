<?php $i=0;?>
  ...
  <tr>
    ...
    <td >
        <a href="<?php echo ci_site_url('admin/sales/order/'.$row->orderid);?>"  class="btn btn-info btn-xs">Detail</a>
        <a  href="<?php echo ci_site_url('admin/sales/shiporder/'.$row->orderid);?>"  class="fancybox fancybox.iframe btn btn-success btn-xs">Ship it</a>
        <a  href="<?php echo ci_site_url('admin/sales/cancel_order/'.$row->orderid);?>"  class="fancybox fancybox.iframe btn btn-warning btn-xs">Cancel</a>
