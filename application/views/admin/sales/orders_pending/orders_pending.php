  ...
  <body>
    ...
    <div class="row">
             ...
             <script>
			 	...
			 	$(document).ready(function(e) {
						 ...
						 function get_pending_order_bydate()
						 {
							 ...
							 {
								 window.location='<?php echo ci_site_url('admin/sales/pending_orders_bydate');?>'+'/0/'+$('#dpd1').val()+'/'+$('#dpd2').val();
							 }
						 }
			 </script>    
     ...
     <div class="row" style="min-height:40px; margin-top:5px">
        <div class="col-md-6">
        <h4 class="admin_title">Orders Received</h4>
        <?php 
				if($fromdate!='')
				{
        ...
        <div class="col-md-6" style="text-align:right">
			...
			?>
			<a href="<?php echo ci_site_url('admin/sales/pdf_orders_pending').$from_to;?>" class="btn btn-info btn-sm">
            	Download PDF
            </a>
        </div>
        <?php }?>
    ...
    <div class="row">
        ...
        <?php //pre_print($orders);?>
        	<table id="pendingorders" width="100%" border="0" class="table table-striped table-bordered" id="order_container">
             <thead>
               <tr>
              ...
              <tbody>
              <?php $this->load->view('admin/sales/orders_pending/orders_pending_inner')?>
              </tbody>
            </table>
