<?php if(get_store_settings('MAINBANNER')=='1'){?>
...
<?php } ?>
<div class="container productscontaner">
	<div class="row ">
    	<?php
		$this->data['offset']=0;
		$this->data['limit']=20;
		$this->data['products']=$this->products_model->get_active_products($this->data['offset'],$this->data['limit']);
		?>
