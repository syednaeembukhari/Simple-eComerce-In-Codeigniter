...
<html lang="en">
  ...
  <body>
     ...
     <div class="row ">
        <div class="col-md-12">
        	<h3 style="text-align:center"><?php echo $this->lang->line('order_thankyou');?></h3>
        	<h4 style="text-align:center"><?php echo $this->lang->line('order_thankyou2');?></h4>
        </div>
      </div>
      
       <div class="row " style="margin-top: 40px">
        <div class="col-md-12" style="text-align:center">
        	 	 <a href="<?php echo site_url('/')?>" class="btn btn-primary  "> <?php echo $this->lang->line('frm_alloffers');?></a>
