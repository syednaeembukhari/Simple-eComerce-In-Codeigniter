...
<link href="<?php echo base_url();?>assets/common/fontawesome5/css/all.min.css" rel="stylesheet">
...
<?php echo get_store_settings('FACEBOOKPIXEL');?>
<?php echo get_store_settings('GOOGLECODE');?>