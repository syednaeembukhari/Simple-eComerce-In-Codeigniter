     	...
     	<div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                	<h3><?php echo $this->lang->line('forgetpassword');?></h3>
                	<form role="form" action="<?php echo ci_site_url('login/forgetpassword')?>" method="post" enctype="multipart/form-data">
                    	<div class="form-group">
                         ...
                         <div class="row">
                             <div class="col-sm-6"><button type="submit" class="btn btn-primary"><?php echo $this->lang->line('getpassword');?></button></div>
                             <div class="col-sm-6" style="padding-top:5px; text-align:right"><a href="<?php echo ci_site_url('login')?>"><?php echo $this->lang->line('login');?></a></div>
                         </div>
                         <div class="row">
